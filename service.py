...
class Service(db.Model):
    ...
    _service_resources = db.Column('service_resources', db.String(600), default = '',  server_default='')
    _service_interconnections = db.Column('service_interconnections', db.String(600), default = '',  server_default='')
